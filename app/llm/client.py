...
Uses OpenAI-compatible API to enhance rule-based analysis with
...
from app.config import settings, get_openai_api_key, get_openai_base_url
...
class LLMClient:
    """
    OpenAI-compatible LLM client for narrative coaching.
