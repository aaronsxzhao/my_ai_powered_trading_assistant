...
class MaterialsRAG:
    ...
    def _ensure_initialized(self) -> bool:
        ...
        try:
            ...
            self._collection = self._chroma_client.get_or_create_collection(
                name="trading_materials", metadata={"hnsw:space": "cosine"}
            )
            ...
            logger.warning(
                f"RAG dependencies not installed: {e}. Run: pip install chromadb sentence-transformers"
            )
            return False
    ...
    def index_materials(self, force: bool = False) -> dict:
        ...
        return {"status": "indexed", "chunks": len(all_chunks), "files": files_indexed}
